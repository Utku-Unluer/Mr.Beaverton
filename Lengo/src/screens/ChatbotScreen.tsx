...
const initialMessages: Message[] = [
  {
    id: '1',
    text: 'Merhaba! Ben Lengo Chatbot. Kelime öğrenme yolculuğunda sana nasıl yardımcı olabilirim?',
    sender: 'bot',
    timestamp: new Date(),
  },
];
  ...
  return (
    <View style={commonStyles.container}>
      <View style={styles.header}>
        ...
        />
        <Text style={styles.headerTitle}>Lengo Chatbot</Text>
        ...
        >
          ...
          <Menu.Item
            onPress={() => {
              setMenuVisible(false);
              Alert.alert(
                'Lengo Chatbot Hakkında',
                'Lengo Chatbot, dil öğrenme yolculuğunuzda size yardımcı olmak için tasarlanmış bir yapay zeka asistanıdır. Kelime öğrenme, test çözme ve liste oluşturma konularında sorularınızı yanıtlayabilir.'
              );
            }}
            title="Hakkında"
      ...
      {isTyping && (
        <View style={styles.typingContainer}>
          <Text style={styles.typingText}>Lengo yazıyor</Text>
