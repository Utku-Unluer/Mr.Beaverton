...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Mr.Beaverton API',
      version: '1.0.0',
      description: 'Mr.Beaverton dil öğrenme uygulaması için API dokümantasyonu',
      contact: {
        name: 'Mr.Beaverton Team',
        url: 'https://github.com/Utku-Unluer/Mr_Beaverton',
      },
    },
    servers: [
      {
